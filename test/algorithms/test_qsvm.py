...
from qiskit_machine_learning.multiclass_extensions import (ErrorCorrectingCode,
                                                           AllPairs,
                                                           OneAgainstRest)
from qiskit_machine_learning.algorithms import QSVM
from qiskit_machine_learning.datasets import ad_hoc_data
from qiskit_machine_learning.utils import split_dataset_to_data_and_labels, optimize_svm


@ddt
class TestQSVM(QiskitMachineLearningTestCase):
    """ Test QSVM """
