...
class TestQuantumKernelTrainer(QiskitMachineLearningTestCase):
    ...
    def test_qkt(self):
        ...
        results = qkt.fit_kernel(self.sample_train, self.label_train)

        # Ensure we get two parameter values, matching our two user parameters
        self.assertEqual(len(results.optimal_point), 2)
