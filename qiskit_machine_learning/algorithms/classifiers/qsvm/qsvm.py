...
from ....utils.dataset_helper import get_num_classes, split_dataset_to_data_and_labels
from ....exceptions import QiskitMachineLearningError
from ....multiclass_extensions.multiclass_extension import MulticlassExtension
    ...
    *multiclass_extension* is required to be supplied. Machine Learning provides several
    ...
    def __init__(self, feature_map: QuantumCircuit,
        ...
        if multiclass_extension is None:
            ...
            multiclass_extension.set_estimator(_QSVM_Estimator, [feature_map])  # type: ignore
