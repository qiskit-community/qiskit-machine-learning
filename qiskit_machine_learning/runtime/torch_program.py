...
class TorchProgramResult:
    """The Torch Train Result object"""
    ...
    def optim_state_dict(self) -> Dict[str, Any]:
        """Returns state dictionary of optimizer after training"""
        return self._optim_state_dict

    @optim_state_dict.setter
    def optim_state_dict(self, state_dict: int) -> None:
        """Sets state dictionary of optimizer after training"""
        self._optim_state_dict = state_dict
...
class TorchProgram:
    """The Qiskit Machine Learning Torch Program to call the Torch runtime."""
    ...
    def loss_func(self, loss: Any) -> None:
        ...
        # The loss function does not have a fixed class like the model or optimizer.
        # It will be checked inside the runtime program.
    ...
    def fit(
        ...
        """Calls the Torch Runtime training program ('torch-train').
    ...
    def predict(self, data_loader: TorchDataloader) -> TorchTensor:
        """Calls the Torch Runtime inference program ('torch-inference') for prediction purposes.
    ...
    def score(self, data_loader: TorchDataloader, score_func: Callable) -> str:
        """Calls the Torch Runtime inference program ('torch-inference') for scoring.
